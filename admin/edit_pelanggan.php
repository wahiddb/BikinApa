                    ...
                    <div class="col">
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                ...
                                include "koneksi.php";
                                $id = $_GET['id'];
                                $query = mysqli_query($connect, "select * from pelanggan where id_pelanggan='$id'") or die(mysqli_error($connect));
                                ...
                                <form method="post" action="aksi_edit_pelanggan.php?id=<?php echo $id ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $telepon; ?>" class="form-control" type="text" name="telepon" onkeypress="return event.charCode >= 48 && event.charCode <=57" required>
                                    </div>
